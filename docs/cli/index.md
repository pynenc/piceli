...
The `piceli` command (also available as `python -m piceli`) has five command groups:
...
| `serve` | Open the local operations dashboard and optionally restore saved forwards. |
