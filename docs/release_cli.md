...
`1` the execution did not become ready or its `[[checks]]` failed, `2` refused
(invalid spec, identity mismatch, unknown or expired plan), `3` approval
required. A refusal with a
