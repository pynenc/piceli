...
```{admonition} Maturity by feature
:class: note

| Feature | Maturity |
| --- | --- |
| Spec, minimal contexts, pinned builder, receipt `piceli.build-receipt.v1` | preview: the receipt fields are a contract; new fields may be added |
