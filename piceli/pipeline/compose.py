...
def resolve(
    ...
    *,
    ...
    ``mirrors`` maps a canonical source reference to its mirrored pull
    reference; a container using a mirrored image pulls the copy (same
    digest) and is pinned like one using a built image.
    """
