...
def access(
    ...
    if unknown:
        ...
        reject("access-unknown-forward", details={"unknown": unknown})
    if not selected:
    ...
    if blocking:
        ...
        reject(
            ...
            details={"conflicts": [item.to_dict() for item in blocking]},
        )
    if dashboard is not None:
        ...
        if taken:
            ...
            reject(
                "access-port-conflict",
                details={"conflicts": [item.to_dict() for item in taken]},
            )
