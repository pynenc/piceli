"""Shared strict validation and bounded calls without Kubernetes package imports."""
...
def bounded_call(
    ...
    *,
    ...
    """Run at most four calls at once, retaining timed-out calls as ambiguous."""
    if deadline - time.monotonic() <= 0 or not slots.acquire(blocking=False):
